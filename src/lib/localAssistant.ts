...
/** Map a teacher question to a sidebar page when it is clearly about Gems Assist. */
...
/** @deprecated use localAssistantAnswer */
export function localAssistantReply(
  message: string,
  context?: { teacherName?: string; classManaged?: string },
): string {
  return localAssistantAnswer(message, context).reply;
}
